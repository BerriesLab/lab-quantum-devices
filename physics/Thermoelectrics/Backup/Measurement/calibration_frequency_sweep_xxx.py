...
for idx_t, val_t in enumerate(t):
    ...
    if thermometer == 1:
        ...
        adc.adw.SetData_Long(list(adc.voltage2bin(zeros(len(temp)) / settings.src2.gain, bits=settings.adc.output_resolution)), 22, 1, len(temp))  # set ao2 data
    if thermometer == 2:
        adc.adw.Set_Par(41, len(temp))  # set length of v1 array
        adc.adw.SetData_Long(list(adc.voltage2bin(temp / settings.src1.gain, bits=settings.adc.output_resolution)), 21, 1, len(temp))  # set ao1 data
        adc.adw.Set_Par(42, len(temp))  # set length of v1 array
    ...
    if thermometer == 2:
        adc.adw.Set_Par(41, len(temp))  # set length of v1 array
        adc.adw.SetData_Long(list(adc.voltage2bin(zeros(len(temp)) / settings.src1.gain, bits=settings.adc.output_resolution)), 21, 1, len(temp))  # set ao1 data
        adc.adw.Set_Par(42, len(temp))  # set length of v2 array
        adc.adw.SetData_Long(list(adc.voltage2bin(temp / settings.src2.gain, bits=settings.adc.output_resolution)), 22, 1, len(temp))  # set ao2 data
    if thermometer == "both":
        adc.adw.Set_Par(41, len(temp))  # set length of v1 array
