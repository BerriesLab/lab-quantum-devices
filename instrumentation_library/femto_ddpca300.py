...
class FemtoDDPCA300:
    ...
    comm = {"gain": {1E4: "0000", 1E5: "0001", 1E6: "0010", 1E7: "0011",
                     1E8: "0100", 1E9: "0101", 1E10: "0110", 1E11: "0111",
                     1E12: "1000", 1E13: "1001"}}
    ...
    def write_settings(self):
        ...
        status = self.dll.WriteData(self.unit, format(
            int("0000" + self.comm["gain"][self.gain], base=2), "#010b"),
                                    0b00000000)
        self.error(status)
