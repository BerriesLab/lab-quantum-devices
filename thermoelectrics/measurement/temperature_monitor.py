...
experiment.experiment_name = "temperature monitor"
experiment.main_path = r"E:\Samples\dabe"
experiment.date = datetime.datetime.now()
experiment.chip = "teps02"
experiment.device = "d2"
experiment.filename = f"{experiment.chip} - {experiment.device} - {experiment.experiment_name}.data"
...
print("\n***** measurement log *****")
path = f"{experiment.main_path}\\{experiment.chip}\\{experiment.device}\\{experiment.experiment_name}\\{experiment.date.strftime('%Y-%m-%d %H.%M.%S')}\\"
try:
