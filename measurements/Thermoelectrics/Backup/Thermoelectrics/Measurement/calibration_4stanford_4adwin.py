...
t = linspace(10, 60, 101)             # [1D array of float] temperatures (in K).
t_h = array([])                     # [1D array of float] temperature (in K) where heater calibration occurs. Pass None to skip.
...
settings.tc.settling_time_init = 1 * 15 * 60    # [float] cryostat initial thermalization time (in s).
