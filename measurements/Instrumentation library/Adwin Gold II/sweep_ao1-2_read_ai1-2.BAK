...
EVENT:
  ...
  SELECTCASE flag '0 = ramp to next voltage point ; 1 = wait ; 2 = measure 
    ...
    CASE 2 'measure --------------------------------
      ...
      'read data
      START_CONV(11b)  'start conversion on ADC1 and ADC2
      WAIT_EOC(11b)  'wit end of conversion on ADC1 and ADC 2
