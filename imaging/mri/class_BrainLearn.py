        ...
        with torch.no_grad():
            ...
            for step_tst, batch_tst in enumerate(epoch_tst_iterator):
                ...
                for sample in samples:
                    img2save = sitk.GetImageFromArray(sample.detach().cpu().numpy().squeeze())
                    sitk.WriteImage(img2save, os.path.join(self.path_main, self._path_results, f"{self.experiment} - tst.nii"))
                    # save score mean to txt
