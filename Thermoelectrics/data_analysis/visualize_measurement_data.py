...
# region ----- Initialize Figure 1: experiment_name summary -----
print("Initializing Figure 1: experiment_name summary... ", end="")
...
for data in datas:
    ...
    if data["experiment_name"] == "calibration r(t)":
        i = data["data"]["iv"][:, 0]
        v = data["data"]["iv"][:, 1]
    ...
    if data["experiment_name"] == "calibration dr(i)":
